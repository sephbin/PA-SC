var Viewport = (function (THREE$1) {
	...
	*/
	...
	function Renderer(domParent, width, height) {
		...
		this._clippingPlane = new THREE$1.Plane( new THREE$1.Vector3( (-10), 0));
		this._helper = new THREE$1.PlaneHelper(this._clippingPlane, 10, 0xffff00);
		...
		function loadGeo(loader, geojson) {
			...
			var material = new THREE$1.MeshPhongMaterial({ 
				color: 0x006DAA,
				shininess: 100,
				side: THREE$1.DoubleSide,
				clipShadows: true
			 });
			const mesh = new THREE$1.Mesh(model.children[0].geometry, material);
			return mesh;
		}
		fetchAPI()
		  .then(results => {
		...
		this.transform = new THREE$1.TransformControls(this._perspCamera, this.renderer.domElement);
